...
var deployCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if isPrecheck {
			...
			if versions, err := PlatformCtx.PlatformClient.GetMultiplayerServerVersions(cmd.Context(), params); err != nil {
		...
		if err := PlatformCtx.PlatformClient.CreateMultiplayerServerVersion(cmd.Context(), moduleID, image, semanticVersion); err != nil {
