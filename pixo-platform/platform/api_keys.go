...
func (g *GraphQLAPIClient) CreateAPIKey(ctx context.Context, input legacy.APIKey) (*legacy.APIKey, error) {
...
func (g *GraphQLAPIClient) GetAPIKeys(ctx context.Context, params *APIKeyQueryParams) ([]*legacy.APIKey, error) {
